...
export class Bukkit extends Object {
   ...
   static getOnlinePlayers (): Collection<X>;
...
export class ConfigurationSerialization extends Object {
   ...
   static getClassByAlias (alias: String): Class<X>;
   getConstructor (): Constructor<X>;
...
export class JavaPluginLoader extends Object implements PluginLoader {
   ...
   createRegisteredListeners (listener: Listener, plugin: Plugin): Map<Class<X>, Set<RegisteredListener>>;
